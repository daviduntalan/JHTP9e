 ...
 * @author David
 */
public class Ex07_18_GameOfCraps {
    ...
    public static void main(String[] args) {
        ...
        // 20th roll and after the 20th roll?
        long winsCount = 0;
        long losesCount = 0;
        
        /**
         * WARNING: 20*Billion took 40 minutes and 54 seconds to complete!
         * Wins : 9,857,524,367
         * Loses: 10,142,475,633
         * 
         * 20*Million took only 2s
         * Wins :    9,858,421
         * Loses:   10,141,579
         */
        for (int i = 0; i < 20; ++i) {
            for (int j = 0; j < 1_000_000; ++j) {
                if (runsAMillionTimes() > 0) 
                    ++winsCount;
                else ++losesCount;
            }
        }
        System.out.printf("Wins : %,12d\nLoses: %,12d\n", winsCount, losesCount);
        
        
    } // end main

    private static int runsAMillionTimes() {
